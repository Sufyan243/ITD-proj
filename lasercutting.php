...
<!-- End Google Tag Manager (noscript) -->
  ...
  <img src="products\lasercuttingbg.jpg" alt="Laser Accessories" style="width:100%; height:50%; display:block; object-fit:cover;">
</div>
    
    <section id="laser-cutting" class="products">
     <h2 class="form-title" style="color: #153170;">About Glorystar Laser</h2>
        <p class="model-title-p"  >Glorystar Laser is a leading high-tech enterprise specializing in the research, development, and manufacturing of advanced fiber laser cutting machines. With over 20 years of innovation, the company provides intelligent metal cutting and automated production solutions used across more than 100 countries. Renowned for precision, reliability, and efficiency, Glorystar’s cutting systems deliver high-performance results for stainless steel, carbon steel, aluminum, and other metals — helping industries achieve smarter and more efficient manufacturing.</p>
  ...
  <button data-filter="gs-c">GS-C Series</button>
  <button data-filter="gs-cl">GS-CL Series</button>
  <button data-filter="gs-cf">GS-CF Series</button>
  <button data-filter="gs">GS Series</button>
  <button data-filter="vs">VS Series</button>
  <button data-filter="ns">NS Series</button>
</div>
...
<div class="product-list">
  ...
  if (mysqli_num_rows($result) > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (str_contains($title, 'gs-cf')) $subcategory = 'gs-cf';
elseif (str_contains($title, 'gs-cl')) $subcategory = 'gs-cl';
elseif (str_contains($title, 'gs-c')) $subcategory = 'gs-c';
elseif (str_contains($title, 'gs')) $subcategory = 'gs';
elseif (str_contains($title, 'vs')) $subcategory = 'vs';
elseif (str_contains($title, 'ns')) $subcategory = 'ns';
else $subcategory = 'classic'; // default fallback
